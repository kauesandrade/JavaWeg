        ...
        if (usuarioLogado instanceof Bibliotecario){
            ...
            if(Midia.procurarMidia(codigo) == null){
               ...
               \nDigite a opção de mídia que deseja cadastrar:
                ...
                switch (escolha){
                    case 1: ((Bibliotecario) usuarioLogado).cadastrarMidia(new DVD(codigo));
                    System.out.println("DVD cadastrado");
                    break;
                    case 2: ((Bibliotecario) usuarioLogado).cadastrarMidia(new Jornal(codigo));
                    System.out.println("Jornal cadastrado");
                    break;
                    case 3: ((Bibliotecario) usuarioLogado).cadastrarMidia(new Livro(codigo));
                    System.out.println("Livro cadastrado");
                    break;
                    case 4: ((Bibliotecario) usuarioLogado).cadastrarMidia(new Revista(codigo));
